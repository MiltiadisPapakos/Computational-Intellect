...
TARGET_CHROMOSOME =targetChromosome[0: 100]
...
rmse =  np.sqrt(((TARGET_CHROMOSOME - population.get_chromosomes()[0].get_fitness())**2).mean())
print(rmse)
mae = np.mean(np.abs(TARGET_CHROMOSOME - population.get_chromosomes()[0].get_fitness()))
print( mae)